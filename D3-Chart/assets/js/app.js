...
xText
  .append("text")
  .attr("y", -26)
  .attr("data-name", "GrammyYear")
  .attr("data-axis", "x")
  .attr("class", "aText active x")
  .text("Year of Grammy Awards");
// // 2. Age
// xText
//   .append("text")
//   .attr("y", 0)
...
yText
  .append("text")
  .attr("y", -45)
  .attr("data-name", "lyric_total_word_count")
  .attr("data-axis", "y")
  .attr("class", "aText active y")
  .text("Lyric Total Word Count");

// 2. Smokes
yText
  .append("text")
  .attr("y", -30)
  .attr("data-name", "lyric_unique_word_count")
  .attr("data-axis", "y")
  .attr("class", "aText inactive y")
  .text("Lyric Unique Word Count");

// 3. Lacks Healthcare
yText
  .append("text")
  .attr("y", -15)
  .attr("data-name", "duration_ms")
  .attr("data-axis", "y")
  .attr("class", "aText inactive y")
  .text("Duration (ms)");
...
d3.csv("assets/data/Record_of_Year_Winner_Features.csv").then(function(data) {
  // Visualize the data
  visualize(data);
});
...
function visualize(theData) {
  ...
  var curX = "GrammyYear";
  var curY = "lyric_total_word_count";
  ...
  var toolTip = d3
    ...
    .html(function(d) {
      ...
      var theX;
      // Grab the state name.
      var theState = "<div>" + d.song_name+"<br>"+d.artist + "</div>";
  ...
  theCircles
    ...
    .attr("class", function(d) {
      return "stateCircle " + d.GrammyYear;
    })
    // Hover rules
